...
<html>
  ...
  <body>
          ...
          <div class="container-xl">
            <div class="row row-deck row-cards">
                      ...
                      <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div class="divide-y">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/002m.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/003m.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/000f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/001f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/002f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/003f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/006m.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/004f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/007m.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/009m.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/010m.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/005f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/006f.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                  ...
                  <div class="card-table table-responsive">
                    <table class="table table-vcenter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/002m.jpg)"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/003m.jpg)"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/000f.jpg)"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
              ...
              <div class="col-md-6 col-lg-4">
                <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/sponsor-banner-homepage.svg)" aria-label="Sponsor Tabler!">
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter">
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url(<?php echo get_template_directory_uri(); ?>/static/avatars/001f.jpg)"></span>
                        </td>
                      </tr>
                    </table>
                  </div>
    ...
    <!-- Libs JS -->
    <script src="<?php echo get_template_directory_uri(); ?>/dist/libs/apexcharts/dist/apexcharts.min.js?1668287865" defer></script>
    <script src="<?php echo get_template_directory_uri(); ?>/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1668287865" defer></script>
    <script src="<?php echo get_template_directory_uri(); ?>/dist/libs/jsvectormap/dist/maps/world.js?1668287865" defer></script>
    <script src="<?php echo get_template_directory_uri(); ?>/dist/libs/jsvectormap/dist/maps/world-merc.js?1668287865" defer></script>
    <!-- Tabler Core -->
